        ...
        <div style="background-color: black;color: white; background-attachment: fixed">
            ...
            <div class="flex-container">
                <div style="background-color: darkred;width: 60%;padding: 30px 30px;">
                    <table>
                        <tr>
                            <th style = 'text-align: center' colspan = '2'><h1>Dance Together</h1></th>
                        </tr>
                        <tr>
                            <td colspan='2'><h5>Latin dance competition and workshop</h5></td>
                        </tr>
                        <tr>
                            <td>Category</td>
                            <td>: Latin</td>
                ...
                <div>
                    <form method="POST" action="validationBook.php">
                        ...
                        <input type="hidden" name="event" value="DT">
                    </form>
                </div>
            </div>
            <br>
