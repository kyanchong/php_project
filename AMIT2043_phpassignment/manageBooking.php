    ...
    <body>
        ...
        <div style="background-color: black;color:whitesmoke; margin: auto">
            ...
            <div style="color:black;background-image:url('./img/6.jpg');height: 60px;background-attachment: fixed">
                <h1>Manage Booking &nbsp;<i style="color:red;font-size: 30px">*Admin Side*</i></h1>
            </div>             
            <br>
            <br>
            <div class="myBooking">
                <form method="POST" action="approveBook.php">
                    <table style = "width:80%; background-image:url('6.jpg');; color:black; background-attachment: fixed">
                        ...
                        if ($result = $dbc->query($query)) {
                            while ($row = $result->fetch_object()) {
                                ...
                                printf("<tr>"
                                        ...
                                        . "<td>%s</td>"
                                        . "<td>%s</td>"
                                        . "<td><input type='submit' name='Approve' value='approve'></td>"  //input
                                        . "</tr>",
                                        $row->BookID,
                                        $row->Name,
                                        $row->Event,
